...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	double *D1, *D0, *Y, *X1_Pr, *X0_Pr, *R_Pr;
	size_t *R_Ir, *R_Jc, *X1_Ir, *X1_Jc, *X0_Ir, *X0_Jc;
	int k0, k1;
	double thres;
	...
	check_scalar(prhs[4], "OMP:Sparsity");
	check_scalar(prhs[5], "OMP:Sparsity");
	check_scalar(prhs[6], "OMP:ErrorTolerance");
	...
	k1 = (int)mxGetScalar(prhs[4]);
	k0 = (int)mxGetScalar(prhs[5]);
	thres = mxGetScalar(prhs[6]);
	...
	c_omp(Y, D1, X1_Pr, X1_Ir, X1_Jc, k1, d_m1, d_n1, D0, X0_Pr, X0_Ir, X0_Jc,
		  k0, d_m0, d_n0, y_n, R_Pr, R_Ir, R_Jc, thres, 1);
